  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="relative">
        ...
        <button
          className={`custom-swiper-button-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 dark:bg-gray-800/80 p-2 rounded-l shadow-md hover:bg-white dark:hover:bg-gray-800 transition-colors ${isBeginning ? 'hidden' : ''
            }`}
        >
          <ChevronLeft className="w-6 h-6 text-gray-700" />
        </button>
        <button
          className={`custom-swiper-button-next absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 dark:bg-gray-800/80 p-2 rounded-l shadow-md hover:bg-white dark:hover:bg-gray-800 transition-colors ${isEnd ? 'hidden' : ''
            }`}
        >
